...
export function LudaDayBanner({ birthDateIso }: LudaDayBannerProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-[860px] px-4 pt-[max(0.75rem,env(safe-area-inset-top))] sm:px-6">
      <div className="rounded-[1rem] border border-[color:var(--color-line)] bg-[color:var(--color-brand-soft)] px-4 py-3 text-[color:var(--color-ink)] shadow-[var(--shadow-soft)]">
        <p className="text-[0.75rem] font-medium text-[color:var(--color-brand-strong)]">성장 배너</p>
