...
export function GuestbookCoverCard() {
  return (
    <section className="mb-4 overflow-hidden rounded-[var(--radius-xl)] bg-[color:var(--color-surface-strong)]/96 p-3.5 shadow-[var(--shadow-soft)] sm:p-4">
      ...
      <div className="relative overflow-hidden rounded-[0.95rem] bg-[color:var(--color-brand-soft)]/36">
        <Image
          src="/luda.jpg"
          alt="루다 대표 사진"
          width={1200}
