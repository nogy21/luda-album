      ...
      <div className="pointer-events-auto mx-auto w-full max-w-[860px] rounded-[1.1rem] border border-[color:var(--color-line)] bg-white/94 px-3.5 py-3 shadow-[var(--shadow-soft)] backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="ui-input min-h-11 flex-1 rounded-full bg-[color:var(--color-surface)] px-3.5 text-[0.84rem] placeholder:text-[color:var(--color-muted)]/75 outline-none"
            maxLength={120}
          />
          <Link
            href={href}
            className="ui-btn ui-btn-primary px-4 text-[0.8rem]"
          >
            덕담 남기기
          </Link>
        </div>
