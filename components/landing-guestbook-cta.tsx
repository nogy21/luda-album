...
export function LandingGuestbookCta() {
  ...
  return (
    <section
      className="pointer-events-none fixed inset-x-0 z-[var(--z-bottom-cta)]"
      style={{ bottom: "var(--floating-guestbook-cta-bottom)" }}
    >
      <div className="layout-container">
        <div className="pointer-events-auto w-full rounded-[1rem] border border-[color:color-mix(in_srgb,var(--color-line)_72%,#fff_28%)] bg-white/86 px-3.5 py-3 shadow-[0_8px_22px_rgb(28_18_24/12%)] backdrop-blur">
